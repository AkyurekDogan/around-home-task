...
run-local-docker-db:
	docker build -t go-around-home-task-postgress -f ./scripts/database/Dockerfile ./scripts/database/
	docker run --name go-around-home-task-postgress -p 5432:5432 -d go-around-home-task-postgress
